...
using BuilderNihongoSekai.WebApp.Data;
using BuilderNihongoSekai.WebApp.Models;
using BuilderNihongoSekai.WebApp.Services;
...
builder.Services.AddHttpClient<IBuilderIoClientService, BuilderIoClientService>(client =>
{
    ...
    client.DefaultRequestHeaders.Add("User-Agent", "BuilderNihongoSekai/1.0 (ASP.NET Core)");
});
